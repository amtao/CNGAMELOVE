...
<tr>
        ...
        <td style="text-align:left;" colspan="3">
            <input type="radio" name="stype" value="1"<?php if(empty($_POST['stype']) || $_POST['stype'] == 1) echo "checked";?>/> 冲榜礼包
            <input type="radio" name="stype" value="2"<?php if($_POST['stype'] == 2) echo "cehcked";?>/> 勋贵礼包
        </td>
</tr>
...
<table style="width: 100%" id="tableId">
    ...
    <?php foreach ($dataList as $key => $value){
        ...
        echo '<td style="text-align:center;">'.$value['giftId'].'</td>';
