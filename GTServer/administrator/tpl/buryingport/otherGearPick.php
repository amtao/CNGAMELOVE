...
<tr><th colspan="6">档位领取状态查询</th></tr>
<tr>
<th>日期范围</th>
<td>
...
<tr>
        ...
        <td style="text-align:left;" colspan="3">
            <input type="radio" name="stype" value="1"<?php if(empty($_POST['stype']) || $_POST['stype'] == 1) echo "checked";?>/> 签到
            <input type="radio" name="stype" value="2"<?php if($_POST['stype'] == 2) echo "cehcked";?>/> 0元购
            <input type="radio" name="stype" value="3"<?php if($_POST['stype'] == 3) echo "checked";?>/> 首冲
            <input type="radio" name="stype" value="4"<?php if($_POST['stype'] == 4) echo "checked";?>/> 钱庄
        </td>
</tr>
...
<table style="width: 100%" id="tableId">
    ...
    <tbody>
    <?php foreach ($signInfo as $key => $value){
...
<table style="width: 100%" id="tableId">
    ...
    <tbody>
    <?php foreach ($zeroInfo as $key => $value){
        echo '<td style="text-align:center;">'.$key.'</td>';
        echo '<td style="text-align:center;">'.$value.'</td>';
        echo '</tr>';
    } ?>
