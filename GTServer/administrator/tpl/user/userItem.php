...
<?php if($uid){?>
	<hr class="hr" />
	<br/>
<?php echo $userModel->info['uid'].' :  <span style="color:red;">'.$userModel->info['name'].'</span>';?>
	<br/>
    ...
    <div style="width: 400px;display: inline-block;float: left;">
        ...
        <form action="" method="post">
            <table style="width: 300px;">
                <tr>
                    <td style="text-align: center;background-color: #B0CFED;">道具名称</td>
                    <td style="text-align: center;background-color: #B0CFED;">数量</td>
                ...
                <tr>
                    ...
                    <td><input name="add_item_value" value="" /></td>
