...
<table>
	 ...
	 <tr>
		...
		<th style="text-align:right;">礼包ID：</th>
		<td style="text-align:left;">
		  <input type="text" id="gid" name="gid" value="<?php echo $_POST['gid'];?>"/>
		</td>
...
<hr class="hr" />
<?php
echo '总计: '.(empty($people)?0:$people).'人            '.(empty($total)?0:$total).'次            '.(empty($money)?0:$money).'美元';?>
<table>
    <tr>
        <th>日期</th>
        <th>次数</th>
    ...
    <tr style="background-color:#f6f9f3;">
        ...
        <td style="text-align:center;"><?php echo $value["num"];?></td>
