...
<table style="width:100%;" class="mytable">
            ...
            if(!empty($list)){
                foreach ($list as $key => $v) {
                    ...
                    echo '<td style="text-align:center;"><a style="border-color: #92799a;background-color: #fb9da3;" href="?sevid='.$SevidCfg["sevid"].'&mod=infomation&act=fenghao&type=jiefeng&closureUid='.$key.'">解封 </a></td>';
                    echo '</tr>';
                }
            }else{
                echo '<tr>';
                echo '<td colspan="2" style="text-align:center;">暂无封号列表</td>';
                echo '</tr>';
            }
            ?>
            </tbody>
