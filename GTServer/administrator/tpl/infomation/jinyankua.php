...
<table style="width:100%;" class="mytable">
            ...
            if(!empty($list)){
                foreach ($list as $uid =>  $v) {
                    ...
                    echo '<td style="text-align:center;"><a style="border-color: #92799a;background-color: #fb9da3;" href="?sevid='.$SevidCfg["sevid"].'&mod=infomation&act=jinyankua&type=jin&banUid='.$uid.'">解禁 </a></td>';
                    echo '</tr>';
                }
            }else{
                echo '<tr>';
