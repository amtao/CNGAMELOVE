...
<tr>
    <th width="200">邮件类型*:</th>
    <td>
        <select class="input" name="type">
            <option value="0">请选择邮件类型</option>
            <option value="1">无奖邮件</option>
            <option value="2">奖励邮件</option>
            <option value="3">单服邮件</option>
            <option value="4">全服邮件</option>
        </select>
    </td>
</tr>
    ...
    <tr id="server"><th>区服选择*:</th><td><input type="text" name="server" style="width: 600px;" size="120" id="title" value="<?php echo isset($_POST['server']) ? $_POST['server'] : 'all';?>">(默认all表示所有服,连续服用"-"隔开如1-20)</td></tr>
    <tr id="vip"><th>vip类型*:</th><td>
            <select name="vipType">
                <option value="1" >最低等级</option>
                <option value="2" >区间</option>
                <option value="3" >间隔</option>
            </select>(<span style="color: red">最低等级</span> 在<span style="color: red">vip等级</span>里填:1表示大于vip需大于1  <span style="color: red">区间vip</span>请使用-隔开,如2-3,表示只有vip2,vip3可收到 <span style="color: red">间隔vip</span>使用,隔开如: 1,4,6表示vip1,vip4,vip6才能收到.<span style="color: red"></span>)</td></tr>
    <tr id="vipLevel"><th>VIP等级*:</th><td><input type="text" name="vip" style="width: 600px;" size="120" id="title" value="<?php echo isset($_POST['vip']) ? $_POST['vip'] : 0;?>"></td></tr>
    <tr id="level"><th>身份等级*:</th><td><select name="level">
