...
define( 'COMBINE_DIR', ROOT_DIR . '/combine' );
...
require_once COMBINE_DIR . '/redisCom.php';
require_once COMBINE_DIR . '/severCom.php';
require_once COMBINE_DIR . '/dbCom.php';
Common::loadModel('Master');
//指定哪些皮使用数据库存储活动配置
$gameActFromDBPF = array(
    // 老爷
    'ypdckw', 'lyjxios', 'gjjpch', 'llhzf', 'gjypmzyw', 'lyjx6kw', 'gjypaf',
    'jwdgr', 'lyjxky', 'lzqdgft', 'lyjx', 'king', 'lyjxtime', 'wsdqg', 'jpwysyh',
    'grwyyh', 'jpdlysm', 'qbcymzyw', 'jpxl', 'bdwykzw', 'grqnejq','gjypdmw',
    'kingft', 'mzywft','gjypmzywft',
    // 大清
    'dqhd', 'sglyqw', 'dqpgshf', 'dqypdckw','dqdwjsky','dqjsmrqt','dqytxpyw','dqgrwhyjs','dqqgwjdly','dqflwysyh',
    'dqhdtest', 'dqxxjlddmw',
    //大明
    'dmypg',
);
