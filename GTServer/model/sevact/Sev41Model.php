...
class Sev41Model extends SevListBaseModel
{
	public $comment = "狩猎-奖励日志";
	public $act = 41;//活动标签
	 ...
	 * 添加一条奖励信息
	 */
	public function add($uid,$guanka,$itemid,$num){
	...
	public function bake_data(){
		$data = $this->get_outf();
		Master::back_data(0,'hunt','rwdLog',$data);
	}
}
