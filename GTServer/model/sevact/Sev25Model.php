...
class Sev25Model extends SevListBaseModel
{
	public $comment = "聊天-跨服频道";
	
    public $b_mol = "chat";//返回信息 所在模块
    public $b_ctrl = "kuafu";//返回信息 所在控制器
	public $act = 25;//活动标签
    ...
    public function add_msg($uid,$msg){
        ...
        //聊天流水
        Game::cmd_chat_flow(2, $uid, $data['user']['name'], $data['user']['vip'], $data['user']['level'], $msg, $data['time']);
    }
