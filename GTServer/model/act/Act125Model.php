 ...
 * 感恩节活动 - 仓库
 */
class Act125Model extends ActBaseModel
{
    public $atype = 125;//活动编号
    public $b_mol = "ThanksDay";//返回信息 所在模块
    public $b_ctrl = "bag";//返回信息 所在控制器
    public $comment = "感恩节活动 - 仓库";
    public $hd_id = "huodong_284";
    ...
    public function randreward($itemcfg_info,$num=1){
        ...
        $Sev71Model = Master::getSev71($hd_cfg['info']['id']);
        foreach($allitems as $ak => $av){
            ...
            if($type == 'rizhi'){
                $Sev71Model->add($this->uid, $itemcfg_info['id'], $ak,$av);
            }
