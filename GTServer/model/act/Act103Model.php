 ...
 * 新官上任 - 积分
 */
class Act103Model extends ActBaseModel
{
	public $atype = 103;//活动编号
	
	public $comment = "新官上任-积分";
	...
	public function addClubScore($cid){
		...
		$Redis107Model->zIncrBy($cid,$this->info['hdscore']);
		Game::cmd_other_flow($cid , 'club', 'huodong_280_'.$this->hd_cfg['info']['id'], array($this->uid), 36, 1, $this->info['hdscore'], $Redis107Model->zScore($cid));
		$this->save();
	}
	/*
     *迁移联盟记录数据
