 ...
 * 活动271
 */
class Act271Model extends ActHDBaseModel
{
	public $atype = 271;//活动编号
	public $comment = "巾帼五虎";
	public $b_mol = "jghuodong";//返回信息 所在模块
	public $b_ctrl = "jinguo";//子类配置
	public $hd_cfg ;//活动配置
	public $hd_id = 'huodong_271';//活动配置文件关键字
	...
	public function get_news(){
		...
		foreach($this->hd_cfg['rwd'] as $rwd){
			//验证道具是否充足
			$flag = $ItemModel->sub_item(129,$rwd['need'],true);
	...
	public function get_rwd($id = 0){
		...
		//先判断道具是否充足
		$ItemModel = Master::getItem($this->uid);
		$ItemModel->sub_item(129,$brwd[$id]['need'],true);
		...
		//扣除道具
		$ItemModel->sub_item(129,$brwd[$id]['need']);
	}
