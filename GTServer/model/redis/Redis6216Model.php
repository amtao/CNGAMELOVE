 ...
 * 晨露消耗排行
 */
class Redis6216Model extends RedisBaseModel
{
    public $comment = "晨露消耗排行";
    public $act = 'huodong_6216';//活动标签

    public $b_mol = "cbhuodong";//返回信息 所在模块
    public $b_ctrl = "plantslist";//返回信息 所在控制器
    ...
    public function back_data_my($member){
        ...
        Master::back_data(0,$this->b_mol,"myPlantsRid",array(
            "rid"=>$rid,
            'score' => $score,
            'name' => $name,
        ));
