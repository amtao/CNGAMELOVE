 ...
 * 活动衙门冲榜
 */
class Redis105Model extends RedisBaseModel
{
	public $comment = "衙门冲榜排行";
	public $act = 'huodong_254';//活动标签
	
	public $b_mol = "cbhuodong";//返回信息 所在模块
	public $b_ctrl = "yamenlist";//返回信息 所在控制器
	...
	*/
	...
	public function back_data_my($member){
		...
		Master::back_data(0,$this->b_mol,"myyamenRid",array(
			"rid"=>$rid,
			'score' => $score,
			'name' => $name,
		));
