 ...
 * 荷灯 - 福气排行
 */
class Redis6234Model extends RedisBaseModel
{
    public $comment = "荷灯-福气排行";
    public $act = 'huodong_6234';//活动标签
    public $out_start = 1;//常规输出范围 从第几个开始 下标从1开始
    public $out_num = 100;//常规输出范围 要获取几个
    public $b_mol = "fanghedeng";//返回信息 所在模块
    public $b_ctrl = "fhdRank";//返回信息 所在控制器
    ...
    */
    ...
    public function back_data_my($uid){
        ...
        Master::back_data(0,$this->b_mol,'myfhdRid',$data);
