 ...
 * 魅力冲榜排行
 */
class Redis258Model extends RedisBaseModel
{
	public $comment = "魅力冲榜排行";
	public $act = 'huodong_258';//活动标签
	
	public $b_mol = "cbhuodong";//返回信息 所在模块
	public $b_ctrl = "meililist";//返回信息 所在控制器
	...
	*/
	...
	public function back_data_my($member){
		...
		Master::back_data(0,$this->b_mol,"myMeiLiRid",array(
			"rid"=>$rid,
			'score' => $score,
			'name' => $name,
		));
