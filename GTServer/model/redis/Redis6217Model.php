 ...
 * 知己技能经验涨幅排行
 */
class Redis6217Model extends RedisBaseModel
{
    public $comment = "知己技能经验涨幅排行";
    public $act = 'huodong_6217';//活动标签

    public $b_mol = "cbhuodong";//返回信息 所在模块
    public $b_ctrl = "wifeskillexplist";//返回信息 所在控制器
    ...
    public function back_data_my($member){
        ...
        Master::back_data(0,$this->b_mol,"myWifeskillexpRid",array(
            "rid"=>$rid,
            'score' => $score,
            'name' => $name,
        ));
