...
class Redis6204Model extends RedisBaseModel
{
    ...
    public function back_data_my($member){
        ...
        Master::back_data(0,$this->b_mol,"myMingShengRid",array(
            "myScorerank"=>$rid,
            'myScore' => $score,
            'myName' => $name,
        ));
