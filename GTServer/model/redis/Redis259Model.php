 ...
 * 粮食冲榜排行
 */
class Redis259Model extends RedisBaseModel
{
	public $comment = "粮食冲榜排行";
	public $act = 'huodong_259';//活动标签
	
	public $b_mol = "cbhuodong";//返回信息 所在模块
	public $b_ctrl = "liangshilist";//返回信息 所在控制器
	...
	*/
	...
	public function back_data_my($member){
		...
		Master::back_data(0,$this->b_mol,"myLiangShiRid",array(
			"rid"=>$rid,
			'score' => $score,
			'name' => $name,
		));
