 ...
 * 偷取晨露次数排行
 */
class Redis6215Model extends RedisBaseModel
{
    public $comment = "偷取晨露次数排行";
    public $act = 'huodong_6215';//活动标签

    public $b_mol = "cbhuodong";//返回信息 所在模块
    public $b_ctrl = "stealcllist";//返回信息 所在控制器
    ...
    public function back_data_my($member){
        ...
        Master::back_data(0,$this->b_mol,"myStealclRid",array(
            "rid"=>$rid,
            'score' => $score,
            'name' => $name,
        ));
