 ...
 * 徒弟势力冲榜排行
 */
class Redis6218Model extends RedisBaseModel
{
    public $comment = "徒弟势力冲榜排行";
    public $act = 'huodong_6218';//活动标签

    public $b_mol = "cbhuodong";//返回信息 所在模块
    public $b_ctrl = "sonshililist";//返回信息 所在控制器
    ...
    public function back_data_my($member){
        ...
        Master::back_data(0,$this->b_mol,"mySonshiliRid",array(
            'uid' => $member,
            "rid"=>$rid,
            'score' => $score,
            'name' => $name,
