...
define('MEMHOST', 'm-wz93c399fcf673f4.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'llhzf1'); //此处要改（mem的名字）
define('MEMPASS', 'llhzf911K');// memcache pass
define('REDISHOST', 'r-wz9917e9fd29a8a4.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'llhzf911K');// redis pass
define('DBHOST', 'rm-wz9n9djnuqw8y01te.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'llhzf');// db user
define('DBPASSWD', 'llhzf@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_llhzf');// db name
define('PREFIX_KEY', 'LLHZF' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'llhzf'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'LLHZF'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/llhzf_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'llhzf.zhisnet.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/llhzf_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'卢里华专服'",// 渠道名称, 作用于后台管理显示
