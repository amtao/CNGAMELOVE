...
define('MEMHOST', 'm-wz9ab2ef5fd171d4.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'bdwykzw1'); //此处要改（mem的名字）
define('MEMPASS', 'bdwykzw911K');// memcache pass
define('REDISHOST', 'r-wz930aff8ea95944.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'bdwykzw911K');// redis pass
define('DBHOST', 'rm-wz9jei127d1k27mws.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'bdwykzw');// db user
define('DBPASSWD', 'bdwykzw@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_bdwykzw');// db name
define('PREFIX_KEY', 'BDWYKZW' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'bdwykzw'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'BDWYKZW'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/bdwykzw_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'bdwykzw.commpad.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/bdwykzw_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'霸道王爷空中网'",// 渠道名称, 作用于后台管理显示
