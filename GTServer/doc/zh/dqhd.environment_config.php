...
define('MEMHOST', 'm-wz94840ad1232284.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'dqhd1'); //此处要改（mem的名字）
define('MEMPASS', 'dqhd911K');// memcache pass
define('REDISHOST', 'r-wz9533031fdd4344.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'dqhd911K');// redis pass
define('DBHOST', 'rm-wz9oucdzcznzv50b9.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'dqhd');// db user
define('DBPASSWD', 'dqhd@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_dqhd');// db name
define('PREFIX_KEY', 'DQHD' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'dqhd'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'DQHD'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/dqhd_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'dqhd.commpad.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/dqhd_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'官方大清皇帝'",// 渠道名称, 作用于后台管理显示
