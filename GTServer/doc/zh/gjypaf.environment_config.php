...
define('MEMHOST', '10.66.206.43');// memcache host
define('MEMPORT', '9101');// memcache port
define('REDISHOST', '10.66.158.34');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'crs-j8hv3nux:gjypaf@zhisnet');// redis port
define('DBHOST', '10.66.207.112');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'gjypaf');// db user
define('DBPASSWD', 'gjypaf@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_gjypaf');// db name
define('PREFIX_KEY', 'GJYPAF' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'gjypaf'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'GJYPAF'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/gjypaf_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'gjypaf.zhisnet.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/gjypaf_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'官居一品安锋'",// 渠道名称, 作用于后台管理显示
