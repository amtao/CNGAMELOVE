...
define('MEMHOST', '10.66.164.4');// memcache host
define('MEMPORT', '9101');// memcache port
define('REDISHOST', '10.66.177.233');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'crs-otja0rez:jwdgr@zhisnet');// redis port
define('DBHOST', '10.66.156.117');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'jwdgr');// db user
define('DBPASSWD', 'jwdgr@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_jwdgr');// db name
define('PREFIX_KEY', 'JWDGR' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'jwdgr'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'JWDGR'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/jwdgr_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'jwdgr.zhisnet.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/jwdgr_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",// 

			'AGENT_CHANNEL_NAME' => "'叫我大官人'",// 渠道名称, 作用于后台管理显示
