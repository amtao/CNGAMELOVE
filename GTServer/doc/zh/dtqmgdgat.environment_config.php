...
define('MEMHOST', '192.168.90.194');// memcache host
define('MEMPORT', '11211');// memcache port
define('REDISHOST', '192.168.90.194');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', '');// redis pass
define('DBHOST', '192.168.90.193');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'dtqmgdgat');// db user
define('DBPASSWD', 'dtqmgdgat@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_dtqmgdgat');// db name
define('PREFIX_KEY', 'DTQMGDGAT' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'dtqmgdgat'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'DTQMGDGAT'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/dtqmgdgat_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'dtqmgdgat.zhisnet.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/dtqmgdgat_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'全民宫斗港澳台'",// 渠道名称, 作用于后台管理显示
