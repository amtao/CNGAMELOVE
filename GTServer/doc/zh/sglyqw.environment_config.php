...
define('MEMHOST', 'm-wz9f15ecc349e434.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'sglyqw1'); //此处要改（mem的名字）
define('MEMPASS', 'sglyqw911K');// memcache pass
define('REDISHOST', 'r-wz9b13db5f920404.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'sglyqw911K');// redis pass
define('DBHOST', 'rm-wz9v940o1q7fb45yp.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'sglyqw');// db user
define('DBPASSWD', 'sglyqw@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_sglyqw');// db name
define('PREFIX_KEY', 'SGLYQW' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'sglyqw'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'SGLYQW'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/sglyqw_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'sglyqw.commpad.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/sglyqw_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'抢玩-三宫六院'",// 渠道名称, 作用于后台管理显示
