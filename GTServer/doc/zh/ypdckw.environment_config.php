...
define('MEMHOST', 'm-wz97713b786014c4.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'ypdckw1'); //此处要改（mem的名字）
define('MEMPASS', 'ypdckw911K');// memcache pass
define('REDISHOST', 'r-wz9c54a900a28e84.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'ypdckw911K');// redis pass
define('DBHOST', 'rm-wz9yyb1jp81vi994s.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'ypdckw');// db user
define('DBPASSWD', 'ypdckw@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_ypdckw');// db name
define('PREFIX_KEY', 'YPDCKW' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'ypdckw'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'YPDCKW'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/ypdckw_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'ypdckw.commpad.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/ypdckw_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'快玩-一品大臣'",// 渠道名称, 作用于后台管理显示
