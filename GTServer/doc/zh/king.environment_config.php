...
define('MEMHOST', '10.66.227.31');// memcache host
define('MEMPORT', '9101');// memcache port
define('REDISHOST', '10.66.227.6');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'crs-8d1g1nfz:king@youdong');// redis port
define('DBHOST', '10.66.227.205');// db host
...
return array(
	...
	'config.php' => array(
		'define' => array(
			...
			'DOMAIN_HOST' => "'s1.king.coolnull.com'",// 入口域名
