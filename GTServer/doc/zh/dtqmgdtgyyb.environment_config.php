...
define('MEMHOST', 'm-wz91371975667014.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'dtqmgdtgyyb1'); //此处要改（mem的名字）
define('MEMPASS', 'grqnejq911K');// memcache pass
define('REDISHOST', 'r-wz91ec97b339b1f4.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'grqnejq911K');// redis pass
define('DBHOST', 'm-wz998sjr34l25rkzt.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'dtqmgdtgyyb');// db user
define('DBPASSWD', 'dtqmgdtgyyb@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_dtqmgdtgyyb');// db name
define('PREFIX_KEY', 'DTQMGDTGYYB' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'dtqmgdtgyyb'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'DTQMGDTGYYB'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/dtqmgdtgyyb_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'dtqmgdtgyyb.commpad.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/dtqmgdtgyyb_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'应用宝专服'",// 渠道名称, 作用于后台管理显示
