...
define('MEMPORT', '11269');// memcache port
define('REDISHOST', '10.104.30.229');// redis host
define('REDISPORT', '6435');// redis port
...
define('DBNAME', 'king');// db name// 's' . SERVER_ID . '_guaji'
define('PREFIX_KEY', 'KINGTest' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 全局公共配置，定义常量
	'config.php' => array(
		'define' => array(
			...
			'DOMAIN_HOST' => "'king2.test.tuziyouxi.com'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/king_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",// 

			'AGENT_CHANNEL_NAME' => "'皇帝'",// 渠道名称, 作用于后台管理显示
