...
define('MEMHOST', '10.66.158.86');// memcache host
define('MEMPORT', '9101');// memcache port
define('REDISHOST', '10.66.159.104');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'crs-kq24vz7n:lyjxky@zhisnet');// redis pass
define('DBHOST', '10.66.157.239');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'lyjxky');// db user
define('DBPASSWD', 'lyjxky@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_lyjxky');// db name
define('PREFIX_KEY', 'LYJXKY' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'lyjxky'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'LYJXKY'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/lyjxky_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'lyjxky.zhisnet.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/lyjxky_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'快游-老爷吉祥'",// 渠道名称, 作用于后台管理显示
