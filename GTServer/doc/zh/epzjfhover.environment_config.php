...
define('MEMHOST', 'm-t4ne2c4fd8ae8604.memcache.singapore.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'epzjfh1'); //此处要改（mem的名字）
define('MEMPASS', '');// memcache pass
define('REDISHOST', 'r-t4n92317cfe5b3f4.redis.singapore.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'Redisplay4fun88ylyz');// redis pass
define('DBHOST', 'rm-t4nczya1zzdvtac10.mysql.singapore.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'zjfhadmin');// db user
define('DBPASSWD', 'n0rNuiEBDQkGnw0AJkJS');// db password
define('DBNAME', 's' . SERVER_ID . '_epzjfhover_game');// db name
define('PREFIX_KEY', 'EPZJFHOVER' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'epzjfhover'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'EPZJFHOVER'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/epzjfhover_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'game-epzjfhover.id-g.com'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/epzjfhover_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'﻿资禁繁花海外正式服'",// 渠道名称, 作用于后台管理显示
