...
define('MEMHOST', '172.19.0.11');// memcache host
define('MEMPORT', '9101');// memcache port
define('REDISHOST', '172.19.0.9');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'crs-163wtp3k:lzqdgft@zhisnet');// redis pass
define('DBHOST', '172.19.0.12');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'lzqdgft');// db user
define('DBPASSWD', 'lzqdgft@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_lzqdgft');// db name
define('PREFIX_KEY', 'LZQDGFT' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'lzqdgft'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'LZQDGFT'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/lzqdgft_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'lzqdgft.zhisnet.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/lzqdgft_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'掌游-老子去当官繁体'",// 渠道名称, 作用于后台管理显示
