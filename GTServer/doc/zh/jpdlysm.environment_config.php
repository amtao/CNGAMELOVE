...
define('MEMHOST', 'm-wz9df9de8ba09844.memcache.rds.aliyuncs.com');// memcache host
define('MEMPORT', '11211');// memcache port
define('MEMUSERNAME', 'jpdlysm1'); //此处要改（mem的名字）
define('MEMPASS', 'jpdlysm911K');// memcache pass
define('REDISHOST', 'r-wz9ff6eb0429ec64.redis.rds.aliyuncs.com');// redis host
define('REDISPORT', '6379');// redis port
define('REDISPASS', 'jpdlysm911K');// redis pass
define('DBHOST', 'rm-wz9lkw7np28407y87.mysql.rds.aliyuncs.com');// db host
define('DBPORT', '3306');// db port
define('DBUSER', 'jpdlysm');// db user
define('DBPASSWD', 'jpdlysm@zhisnet');// db password
define('DBNAME', 's' . SERVER_ID . '_jpdlysm');// db name
define('PREFIX_KEY', 'JPDLYSM' . 'S' . SERVER_ID . 's');// 缓存前缀
return array(
	// 路由配置文件1
	...
	'config.php' => array(
		'define' => array(
			...
			'GAME_MARK' => "'jpdlysm'",// 游戏标记
			'AGENT_CHANNEL_ALIAS' => "'JPDLYSM'",// 区分渠道标识
			'LOG_PATH' => "'/data/logs/jpdlysm_log/' . date('Ymd') . '/'",// 日志目录
			'DOMAIN_HOST' => "'jpdlysm.commpad.cn'",// 入口域名
			'USE_PHPLOCK' => 'true',// 开启文件锁
			'LOCK_PATH' => "'/data/logs/jpdlysm_log/'",// 文件锁日志目录
			'FILE_PATH' => "'/data/logs/'",//

			'AGENT_CHANNEL_NAME' => "'手盟-极品大老爷'",// 渠道名称, 作用于后台管理显示
